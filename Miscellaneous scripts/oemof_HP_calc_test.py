...
energysystem.add(solph.Sink(
    label='demand',
    inputs={b_heat: solph.Flow(actual_value=data['Wärmelastprofil'],
                               fixed=True,
                               nominal_value=1)}))
...
nominal_conditions = {'nominal_Q_hot': 100*25,
                      'nominal_el_consumption': 100*7}
